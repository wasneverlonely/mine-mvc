...
public final class CrashUtils {
    ...
    public static Application mApplication;// 全局apliction
    ...
    public static boolean init(Application application, final String crashDir) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
            ...
            defaultDir = mApplication.getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = mApplication.getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
